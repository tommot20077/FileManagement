/**
 * 枚舉類，用於定義常量
 * 1. ByteEnum: 用於定義文件大小的單位 {@link xyz.dowob.filemanagement.customenum.ByteEnum}
 * 2. CacheProviderEnum: 用於定義緩存提供器的類型 {@link xyz.dowob.filemanagement.customenum.CacheProviderEnum}
 * 3. ConvertProviderEnum: 用於定義轉換提供器的類型 {@link xyz.dowob.filemanagement.customenum.ConvertProviderEnum}
 * 4. CsrfTokenRepositoryEnum: 用於定義 CsrfTokenRepository 的存儲方式 {@link xyz.dowob.filemanagement.customenum.CsrfTokenRepositoryEnum}
 * 5. DownloadActionEnum: 用於定義下載動作 {@link xyz.dowob.filemanagement.customenum.DownloadActionEnum}
