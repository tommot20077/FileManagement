 ...
 * 1. CacheProviderType: 用於標記緩存提供器的類型 {@link xyz.dowob.filemanagement.annotation.CacheProviderType}
 * 2. CsrfRepositoryType: 用於標記 CsrfTokenRepository 的實現類型 {@link xyz.dowob.filemanagement.annotation.CsrfRepositoryType}
