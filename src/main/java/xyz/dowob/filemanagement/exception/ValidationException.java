...
public class ValidationException extends Exception {
    ...
    public enum ErrorCode {
         ...
         * 錯誤信息: 帳號驗證失敗
         */
        AUTHENTICATION_FAILED(1110, "驗證身分失敗"),
        /**
         * 錯誤碼: 1111
         * 錯誤信息: 請求參數無效
         */
         ...
         * 錯誤信息: 文件名稱無效
         */
        FILE_NAME_INVALID(1115, "文件名稱無效，文件名稱不能為空或無副檔名"),
        /**
         * 錯誤碼: 1116
         * 錯誤信息: 文件名稱過長
         */
        FILE_NAME_TOO_LONG(1116, "文件名稱過長，文件名稱不能超過 200 字元"),
        /**
         * 錯誤碼: 1117
         * 錯誤信息: 文件路徑無效
         */
        FILE_PATH_INVALID(1117, "文件路徑無效，文件路徑不能為空，需以 / 開頭和結尾"),
        /**
         * 錯誤碼: 1118
         * 錯誤信息: 文件路徑過長
         */
        FILE_PATH_TOO_LONG(1118, "文件路徑過長，文件路徑不能超過 200 字元"),
        ;
