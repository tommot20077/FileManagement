...
class ValidationServiceTest {
    ...
    class validSpecifyColumnTests {
        ...
        void validSpecifyColumn_WithNullDTO_ShouldReturnError() {
            // when
            Mono<Void> result = validationService.validSpecifyColumn(null, "name");
        ...
        void validSpecifyColumn_WithNonExistentColumn_ShouldReturnError() {
            ...
            // when
            Mono<Void> result = validationService.validSpecifyColumn(dto, "nonexistent");
        ...
        void validSpecifyColumn_WithNullDeclaredFields_ShouldReturnError() {
            ...
            // when
            Mono<Void> result = validationService.validSpecifyColumn(dto, "name");
        ...
        void validSpecifyColumn_WithMissColumns_ShouldReturnError() {
            ...
            // when
            Mono<Void> result = validationService.validSpecifyColumn(dto, "name", "age");
        ...
        void validSpecifyColumn_WithBlankField_ShouldReturnError() {
            ...
            // when
            Mono<Void> result = validationService.validSpecifyColumn(dto, "name");
            Mono<Void> result2 = validationService.validSpecifyColumn(dto2, "name");
            // then
            StepVerifier
                    .create(result)
